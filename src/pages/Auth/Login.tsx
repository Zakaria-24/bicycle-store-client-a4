...
import loginImgAnimation from "../../assets/images/loginImgAnimation.avif";
...
const Login = () => {
  ...
  return (
    ...
    Welcome to our bicycle store! We offer a wide range of
                </p>
              </div>
            </div>
          </article>
          <main className="border border-overlyBg rounded-md md:w-1/2 flex flex-col items-center justify-center px-8 py-8 sm:px-12 ">
            ...
            <div className="w-full">
              ...
              <p className="text-xs text-center mt-3 text-secondary">
                ...
                <Link
                  to="/sign-up"
                  className="font-semibold hover:underline text-[#E63946]"
                >
                  Sign Up
                </Link>
              </p>
