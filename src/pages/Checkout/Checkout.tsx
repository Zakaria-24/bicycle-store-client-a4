                ...
                <div className="relative">
                  <ul className="relative flex w-full items-center justify-between space-x-2 sm:space-x-4">
                    <li className="flex items-center space-x-3 text-left sm:space-x-4">
                      <a
                        className="flex h-6 w-6 items-center justify-center rounded-full bg-[#ce6b73] text-xs font-semibold text-[#E63946]"
                        href="#"
                      >
                        <svg
                        ...
                        <div className="flex justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <button
                              ...
                              className="bg-gray-300 hover:bg-[#E63946] p-2 rounded hover:text-white transition group"
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                ...
                <form className="mt-5 ">
                  ...
                  <div className="relative">
                    <input
                      ...
                      checked
                    />
                    <span className="peer-checked:border-[#E63946] absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
                    <label
                      className="peer-checked:border-2 peer-checked:border-[#E63946] peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4"
                      htmlFor="radio_2"
                    >
                      <img
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        name="name"
                        value={me?.data?.name}
                        className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-[#E63946] focus:ring-[#E63946]"
                        readOnly
                      />
                    </div>
                  </div>
