...
import profileImg from "../../../assets/images/bicycle-logo.png"
            ...
            {showMibileMenu && (
              ...
              >
                ...
                {userRole ? (
                  <Link
                    to="/dashboard"
                    className="bg-[#E63946] w-fit active:bg-[#E63946] uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150"
                  >
                    Dashboard
                  </Link>
                ) : (
                      ...
                      <div className="p-2">
                        {userRole === "admin" && (
                          <Link
                            ...
                            className="block rounded-lg px-4 py-2 text-sm text-secondary hover:bg-[#E63946] hover:text-white"
                            role="menuitem"
                          >
                            Dashboard
                          </Link>
                      ...
                      <div className="p-2">
                        <div>
                          <button
                            ...
                            className="flex w-full items-center gap-2 rounded-lg px-4 py-2 text-sm text-secondary hover:bg-[#E63946] hover:text-white"
                            role="menuitem"
                          >
                            <svg
