    ...
    <footer className="bg-secondary mt-10 lg:mt-20">
      <MyContainer>
          ...
          <div className="">
            ...
            <ul className="mt-4 flex justify-start gap-6 sm:mt-2">
              <li>
                <a
                  href="#"
                  rel="noreferrer"
                  target="_blank"
                  className="text-white transition hover:text-[#E63946]"
                >
          ...
          <p className="text-lg text-center text-[#E63946] py-10">
            &copy; 2025. Bicycle Store. All rights reserved.
          </p>
